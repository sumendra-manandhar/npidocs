...
# 7. Source Authentication in NPI 
...
## 7.2. API Layer (Basic/User authentication and Access/Refresh token to get the API resources) 
...
## 7.3. Accounting Layer (Whitelisting of Source Debtor Account) 
